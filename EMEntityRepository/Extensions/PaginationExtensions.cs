...
namespace EMEntityRepository.Extensions
{
    public static class PaginationExtensions
    {
        ...
        /// <summary>
        /// Get result from List<IEntity> list with pagination / Получить результат из списка List<IEntity> с нумерацией страниц
        /// </summary>
        /// <param name="data"></param>
        /// <param name="pageIndex"></param>
        /// <param name="pageSize"></param>
        /// <returns></returns>
        public static PagedResult<TEntity> ToPagedList<TEntity>(this List<TEntity> data, int pageIndex = 0, int pageSize = 10) where TEntity : class
        {
